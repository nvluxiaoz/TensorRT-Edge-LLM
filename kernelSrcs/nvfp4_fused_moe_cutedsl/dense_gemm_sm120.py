...
# adapted for the current Blackwell GeForce target. Originally from the b12x
# kernel library.
...
class DenseGemmKernel:
    ...
    # wrapper: compile-time entry point for AOT export
    @cute.jit
    def wrapper(
        self,
        mA: cute.Tensor,
...
# Stable public alias used by moe_decode_kernel.py / moe_prefill_kernel.py.
