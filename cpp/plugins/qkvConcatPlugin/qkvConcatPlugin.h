...
class QkvConcatPlugin : public nvinfer1::IPluginV3,
                        public nvinfer1::IPluginV3OneCore,
                        public nvinfer1::IPluginV3OneBuild,
                        public nvinfer1::IPluginV3OneRuntime
{
public:
    explicit QkvConcatPlugin(std::string const& name);
...
private:
    ...
    nvinfer1::PluginFieldCollection mFields{};
};

class QkvConcatPluginCreator : public nvinfer1::IPluginCreatorV3One
{
public:
    QkvConcatPluginCreator() = default;
